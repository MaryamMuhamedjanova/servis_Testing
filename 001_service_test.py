...
def service_001_body1(accountDebit, accountCredit):
...
def positive_assert_amount_with_accountDebit_and_accountCredit(accountDebit, accountCredit):
    service_001_amount_body = service_001_body1(accountDebit, accountCredit)
...
# Класс с тестами
@allure.suite("Перевод между счетами клиента(-ов) (001 сервис)")
