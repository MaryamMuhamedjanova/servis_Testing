...
def get_017_body(accountDebit, accountCredit,currency):
...
def positive_assert_amount_with_accountDebit_and_accountCredit(accountDebit, accountCredit,currency):
    service_017_body = get_017_body(accountDebit, accountCredit,currency)
...
# Класс с тестами
@allure.suite("(017 сервис) Перевод со счета банка на карту")
