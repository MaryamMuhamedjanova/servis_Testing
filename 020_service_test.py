...
def get_020_body(accountDebit, accountCredit):
    current_body = data.service_020_body.copy()
...
def positive_assert_amount_with_accountDebit_and_accountCredit(accountDebit, accountCredit):
    service_020_body = get_020_body(accountDebit, accountCredit)
    payment_response = esb_request.service_post(service_020_body)
...
# Класс с тестами
@allure.suite("(020 сервис) Взимание комиссии со счета банка")
class TestAmountSuite:
    ...
    @allure.title("Взимание комиссии со счета банка (KGS)")
